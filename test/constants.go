...
var (
	...
	KEYCLOAK_FIND_USERS_BY_ORG_ID_GROUPS  = "http://localhost:8080/admin/realms/master/groups?briefRepresentation=false&full=true&q=org_id%3A23"
	KEYCLOAK_FIND_USERS_BY_ORG_ID         = "http://localhost:8080/admin/realms/master/users?q=org_id:23"
	KEYCLOAK_FIND_USERS_BY_EMAIL1         = "http://localhost:8080/admin/realms/master/users?email=1%401.com&q=org_id%3A23"
	KEYCLOAK_FIND_USERS_BY_EMAIL2         = "http://localhost:8080/admin/realms/master/users?email=2%402.com&q=org_id%3A23"
	...
	KEYCLOAK_FIND_USERS_BY_USERID1        = "http://localhost:8080/admin/realms/master/users?id=c2979a54-b50e-473a-8ff8-0710f701e64f&q=org_id%3A23"
	KEYCLOAK_FIND_USERS_BY_USERID2        = "http://localhost:8080/admin/realms/master/users?id=3c577a73-d15a-4130-968b-1fdab10e0ee0&q=org_id%3A23"
	KEYCLOAK_ACTIVATE_USER_ID             = "779edba7-2dbe-44f5-89f8-38ccd3368b30"
	KEYCLOAK_ACTIVATE_USER_URL            = "http://localhost:8080/admin/realms/master/users/" + KEYCLOAK_ACTIVATE_USER_ID
	KEYCLOAK_ACTIVATE_USER_GET_GROUPS_URL = "http://localhost:8080/admin/realms/master/users/" + KEYCLOAK_ACTIVATE_USER_ID + "/groups"
	KEYCLOAK_ACTIVATE_USER_GET_USER_URL   = "http://localhost:8080/admin/realms/master/users/" + KEYCLOAK_ACTIVATE_USER_ID
	EMPTY_PARAM_WITH_SPACE                = " "                                                // Used in tests, to clearly indicate a blank space is being passed
	KEYCLOAK_USERS_PATH                   = "http://localhost:8080/admin/realms/master/users/" // Warning: Do not change, may cause test failures
)
